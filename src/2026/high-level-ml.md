...
Request C (optional): The Reflection proposal might be one potential path to stabilize the autodiff and offload projects by "outsourcing" it into common crates, _if_ we decide to previde the necessary abilities via a future reflection implementation. We should sync up!
