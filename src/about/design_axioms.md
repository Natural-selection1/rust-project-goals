...
- **Axioms express tradeoffs.** Axioms are ordered, and -- in case of conflict -- the axioms that come earlier in the list take precedence. Since _axioms capture constraints_, this doesn't mean you just ignore the axioms that take lower precedence, but it usually means you meet them in a "less good" way. For example, maybe consider a lint instead of a hard error?
