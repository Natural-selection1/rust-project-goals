...
- Implement a feature to show type signatures in type-driven search results, so it's easier to figure out _why_ a result came up <https://github.com/rust-lang/rust/pull/124544>.
...
The goal is to reach this point _without trying to be a better Google than Google is._ Rustdoc Search should focus on what it can do that other search engines can't:
